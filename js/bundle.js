...
function calc() {
  ...
  checkLocal('.calculating__choose_big div', 'calculating__choose-item_active');
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(src, alt, tittle, descr, price, parentSelector) {
...
/* harmony import */ var _services_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../services/service */ "./js/services/service.js");
...
function forms(formsSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_service__WEBPACK_IMPORTED_MODULE_10__.postData)('http://localhost:3000/requests', json).then(function (data) {
        console.log(data);
...
function slides(_ref) {
  ...
  total.innerHTML = getZero("".concat(slides.length));
  curr.innerHTML = getZero("".concat(slideIndex));
  ...
  dots.forEach(function (dot) {
    dot.addEventListener('click', function (e) {
      var slideTo = e.target.getAttribute('date-slide-to');
      slideIndex = slideTo;
...
function tabs(_ref) {
  var tabItem = _ref.tabItem,
      tabMain = _ref.tabMain,
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return (0,_modules_modal__WEBPACK_IMPORTED_MODULE_5__.openModal)(modalSelector, modalTimerId);
  }, 300000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_8__["default"])('.timer', '2022-02-25');
});
})();
